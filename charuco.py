...
class Arco:
    def __init__(self):
        self.num_marker_x = 10
        self.num_marker_y = 7
        self.res_board_x = 1000
        self.res_board_y = 700
    ...
    def read_chessboards_stereo(self, images_1, images_2, files_1=None, files_2=None):
        ...
        for i, (img_1, img_2) in enumerate(zip(images_1, images_2)):
            ...
            if both_exist:
                ...
                if valid_1 and valid_2 and decimator%1==0:
                    allCorners_1.append(res_1[1])
                    allCorners_2.append(res_2[1])
                    allIds_1.append(res_1[2])
                    allIds_2.append(res_2[2])
                    index.append(1)
                    print("success")
                else:
                    index.append(0)
        ...
        imsize = gray_1.shape
        return allCorners_1,allCorners_2,allIds_1,allIds_2,imsize,index
    ...
    # Calibration STEREO
    def calibrate_camera_stereo(self, allCorners_1, allCorners_2, allIds_1, allIds_2, imsize):
        """
        Calibrates the camera using the dected corners.
        """
