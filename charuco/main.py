...
board = aruco.CharucoBoard_create(marker_x_num,marker_y_num, 1, .80, aruco_dict)
...
dot_pitch = 0.27 * 0.001#[m]
dot_pitch = 0.181 *0.001#[m]
marker_pixel_size = 100#[px]

marker_real_size = 14.3*0.001#dot_pitch * marker_pixel_size
